...
// Assuming you're using these from your form library
// Form and FormField components would be imported from your form library
          ...
          <div className="flex flex-col md:flex-row">
            ...
            <div className="bg-gray-900 p-8 flex items-center justify-center md:w-2/5">
              <div className="text-center">
                ...
                <h2 className="text-xl font-bold text-white">InterviewAI</h2>
